...
- [!] **Опасно!** Нужен стабильный источник ровно 3.3V
...
| Только VIN, 5V, 3.3V | [x] Контроллера заряда нет |
...
## [x] Почему нельзя напрямую от аккумулятора
...
## [x] Почему TP4056 — не лучший выбор
