...
cover: "/images/guides//esp32-oled-096.png"
---

# [#] Подключение OLED 0.96" к ESP32 — полный гайд
...
| [o_o] Отличный контраст | Видно даже на солнце |
...
[!] **Важно:** Подключай к 3.3V, не к 5V! Хотя многие модули имеют стабилизатор, лучше не рисковать.
...
[i] **Совет:** Можно использовать Dupont провода напрямую без пинов — просто припаять провода к площадкам.

---

## [#] Адрес I2C и перемычка
...
[i] **Важно:** Пока не вызовешь `display.display()` — на экране ничего не изменится!
